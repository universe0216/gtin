...
<script src="<?php echo base_url('assets/js/sortable_table.js'); ?>"></script>
<script src="<?php echo base_url('assets/js/entity_list.js'); ?>"></script>
<script src="<?php echo base_url('assets/js/organization_detail.js'); ?>"></script>
